 ...
 *   https://datatables.net/download/#se/jq-3.3.1/dt-1.10.24/r-2.2.7
 *
 * Included libraries:
 *   jQuery 3 3.3.1, DataTables 1.10.24, Responsive 2.2.7
 */
...
$jscomp.propertyToPolyfillSymbol[d],$jscomp.defineProperty(e,d,{configurable:!0,writable:!0,value:b})))};$jscomp.polyfill("Array.prototype.find",function(a){return a?a:function(b,c){return $jscomp.findInternal(this,b,c).v}},"es6","es3");
(function(a){"function"===typeof define&&define.amd?define(["jquery","datatables.net-se","datatables.net-responsive"],function(b){return a(b,window,document)}):"object"===typeof exports?module.exports=function(b,c){b||(b=window);c&&c.fn.dataTable||(c=require("datatables.net-se")(b,c).$);c.fn.dataTable.Responsive||require("datatables.net-responsive")(b,c);return a(c,b,b.document)}:a(jQuery,window,document)})(function(a,b,c,e){b=a.fn.dataTable;c=b.Responsive.display;var d=c.modal,f=a('<div class="ui modal" role="dialog"><div class="header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button></div><div class="content"/></div>');
c.modal=function(g){return function(h,k,l){a.fn.modal?k||(g&&g.header&&f.find("div.header").empty().append('<h4 class="title">'+g.header(h)+"</h4>"),f.find("div.content").empty().append(l()),f.parent().hasClass("dimmer")||f.appendTo("body"),f.modal("show")):d(h,k,l)}};return b.Responsive});
