...
from app.models.alpaca_db_models import Stocks,Quotes
...
class QuotesController():
    ...
    async def get_quotes_by_ticker(self,ticker,start=None,end=None,limit=5000):
    
        data=await self.query_data(Quotes,"quotes",parameter_val = ticker, start = start, end = end , limit = limit)
        return data
